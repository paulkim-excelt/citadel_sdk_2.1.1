...
const struct mmu_mem_region_info mem_region_info[] = {
	/* Boot ROM */
	{
 ...
 * @return 0
 */
static int bcm5820x_init(struct device *arg)
{
	ARG_UNUSED(arg);

#ifdef CONFIG_ARM_CORE_MMU
	arm_core_mmu_init((struct mmu_mem_region_info *)mem_region_info,
...
SYS_INIT(bcm5820x_init, PRE_KERNEL_1, CONFIG_SOC_CONFIG_PRIORITY);

...
MEMORY
    {
    FLASH (rx) : ORIGIN = (0x63000000 + 1024 + 0x0), LENGTH = (8192*1K - 1024)
    SRAM (wx) : ORIGIN = (0x24000000 + 64 * 1K), LENGTH = (1024 * 1K - 64 * 1K)
    IDT_LIST (wx) : ORIGIN = ((0x24000000 + 64 * 1K) + (1024 * 1K - 64 * 1K)), LENGTH = 2K
    }
ENTRY("__start")
SECTIONS
    {
 ...
 *(.iplt)
 ...
 _image_rom_start = (0x63000000 + 1024 + 0x0);
    text :
 {
 _image_text_start = .;
 . = 0x0;
 ...
 *(.igot)
 ...
 . = ALIGN(4);
 _image_ram_start = .;
 _aligned_noinit_data (NOLOAD) : ALIGN_WITH_INPUT
 {
 ...
 *(.ramfunc.rodata*)
  ...
  *(".usb.data")
  ...
  __usb_data_end = .;
    ...
    _image_ram_end = .;
    _end = .;
    __kernel_ram_end = (0x24000000 + 64 * 1K) + (1024 * 1K - 64 * 1K);

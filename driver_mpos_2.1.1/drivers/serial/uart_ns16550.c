...
#else
#ifndef CONFIG_UART_NS16550_32BIT_ONLY
#define READ(x) sys_read8(x)
#define WRITE(x, d) sys_write8(d, x)
#else
#define READ(x) sys_read32(x)
#define WRITE(x, d) sys_write32(d, x)
#endif
 ...
 */
int uart_ns16550_init(struct device *dev)
{
	struct uart_ns16550_dev_data_t * const dev_data = DEV_DATA(dev);
	 ...
	 */
	mdc = FCR_FIFO | FCR_MODE0 | FCR_FIFO_8 | FCR_RCVRCLR | FCR_XMITCLR;
 ...
 */
unsigned char uart_ns16550_poll_out(struct device *dev,
					   unsigned char c)
{
...
static void irq_config_func_0(struct device *dev)
{
	...
	IRQ_CONNECT(SPI_IRQ(UART_NS16550_PORT_0_IRQ),
		    CONFIG_UART_NS16550_PORT_0_IRQ_PRI,
		    uart_ns16550_isr, DEVICE_GET(uart_ns16550_0),
		    UART_IRQ_FLAGS);
	irq_enable(SPI_IRQ(UART_NS16550_PORT_0_IRQ));
}
#endif
...
static void irq_config_func_1(struct device *dev)
{
	...
	IRQ_CONNECT(SPI_IRQ(UART_NS16550_PORT_1_IRQ),
		    CONFIG_UART_NS16550_PORT_1_IRQ_PRI,
		    uart_ns16550_isr, DEVICE_GET(uart_ns16550_1),
		    UART_IRQ_FLAGS);
	irq_enable(SPI_IRQ(UART_NS16550_PORT_1_IRQ));
}
#endif
...
static const struct uart_ns16550_device_config uart_ns16550_dev_cfg_2 = {
	.sys_clk_freq = UART_NS16550_PORT_2_CLK_FREQ,
...
static struct uart_ns16550_dev_data_t uart_ns16550_dev_data_2 = {
	...
	.port = UART_NS16550_PORT_2_BASE_ADDR,
...
static void irq_config_func_2(struct device *dev)
{
	...
	IRQ_CONNECT(SPI_IRQ(UART_NS16550_PORT_2_IRQ),
		    CONFIG_UART_NS16550_PORT_2_IRQ_PRI,
		    uart_ns16550_isr, DEVICE_GET(uart_ns16550_2),
		    UART_IRQ_FLAGS);
	irq_enable(SPI_IRQ(UART_NS16550_PORT_2_IRQ));
}
#endif
...
static const struct uart_ns16550_device_config uart_ns16550_dev_cfg_3 = {
	.sys_clk_freq = UART_NS16550_PORT_3_CLK_FREQ,
...
static struct uart_ns16550_dev_data_t uart_ns16550_dev_data_3 = {
	...
	.port = UART_NS16550_PORT_3_BASE_ADDR,
...
static void irq_config_func_3(struct device *dev)
{
	...
	IRQ_CONNECT(SPI_IRQ(UART_NS16550_PORT_3_IRQ),
		    CONFIG_UART_NS16550_PORT_3_IRQ_PRI,
		    uart_ns16550_isr, DEVICE_GET(uart_ns16550_3),
		    UART_IRQ_FLAGS);
	irq_enable(SPI_IRQ(UART_NS16550_PORT_3_IRQ));
}
#endif

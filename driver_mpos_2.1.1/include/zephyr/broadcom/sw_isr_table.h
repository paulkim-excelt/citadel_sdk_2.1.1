...
/* In Zephyr, the _ISR_DECLARE enters everything into the ISR table.  We don't
 * exactly have that.
 */
int gic400_install_isr(u32_t irq, u32_t flags, void (*func)(void *), void *p);
...
#define _ISR_DECLARE(irq, flags, func, param) \
	gic400_install_isr(irq, flags, func, param)

...
uint32_t cpu_rd_single(uint32_t addr, int size)
{
    return (((size == 1) ?  *((volatile uint8_t *)addr) :
                            ((size == 2) ? *((volatile uint16_t *)addr) :
                            ((size == 8) ? *((volatile uint64_t *)addr) :
                            *((volatile uint32_t *)addr)))) );
}

void cpu_wr_single(uint32_t addr, uint32_t data, int size)
{
    if(size == 1) *((volatile uint8_t *)addr) = data ;

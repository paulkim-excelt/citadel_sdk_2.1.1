...
#ifndef _CVPROMPTS_H_
#define _CVPROMPTS_H_ 1
...
#define MIN_PIN_LENGTH 1
#define MAX_PIN_LENGTH 256

#define PROMPT_NONE					0		/* no prompt */
#define PROMPT_LENGTH				64 		/* length of the prompt */
#define PIN_MSG_LENGTH				64		/* length of the PIN message*/

BOOL bUserCanceledThePrompt;
cv_status uPrvPromptCode ;

char pPinValue[MAX_PIN_LENGTH];

...
../secimage chain -out chain.bin -sig chain.nosign.bin.cygnus.b0.productid.0xabcd.2.bin.file_4864_CYGNUS-B0-ROT.sign -rsa -key -public CYGNUS-B0-CHAIN1.pem 0x0 0xABCD 0x01

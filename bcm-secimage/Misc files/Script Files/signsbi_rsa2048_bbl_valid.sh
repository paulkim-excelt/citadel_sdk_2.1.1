chmod +w chain.out
secimage chain -out chain.out -rsa -key rsa_eng_key.pem 0x001E0000 0 -BBLStatus 1 -key rsa_sbi1.pem 0x001E0000 0 -BBLStatus 1 -key rsa_sbi2.pem 0x001E0000 0 -BBLStatus 1 -key rsa_sbi3.pem 0x001E0000 0 -BBLStatus 1
